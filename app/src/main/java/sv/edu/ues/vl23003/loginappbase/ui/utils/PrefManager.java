package sv.edu.ues.vl23003.loginappbase.ui.utils; // paquete donde vive el gestor de preferencias

import android.content.Context; // importacion para acceder al contexto de la aplicacion
import android.content.SharedPreferences; // importacion para guardar datos locales
