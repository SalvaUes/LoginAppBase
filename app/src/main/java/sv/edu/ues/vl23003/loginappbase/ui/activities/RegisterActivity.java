package sv.edu.ues.vl23003.loginappbase.ui.activities; // paquete de actividades para el registro de usuarios

import android.os.Bundle; // importacion para usar el ciclo de vida de la actividad
import android.util.Patterns; // importacion para validar formato de correo electronico
import android.widget.Button; // importacion para manejar botones en la interfaz
import android.widget.EditText; // importacion para capturar texto en pantalla
...
import sv.edu.ues.vl23003.loginappbase.R; // recurso del proyecto que conecta con los layouts y vistas
import sv.edu.ues.vl23003.loginappbase.ui.utils.PrefManager; // gestor de preferencias para guardar datos locales
